...
print(top3[["stations", "distance", "magnets", "dv", "dv_sem"]].to_string(index=False))

print("\n===== WORST 3 CONFIGURATIONS =====\n")
print(worst3[["stations", "distance", "magnets", "dv", "dv_sem"]].to_string(index=False))

# SUMMARY TABLE OF ALL CONFIGURATIONS 
print("\n===== FINAL TABLE =====\n")
print(full[[
    "stations", "distance", "magnets",
